...
// scroll reveal
  ...
  (function(){
    ...
    const usdtSvg='<svg class="coin" viewBox="0 0 32 32" aria-hidden="true"><circle cx="16" cy="16" r="16" fill="#26A17B"/><g fill="#fff"><rect x="7.6" y="9" width="16.8" height="3" rx="1.3"/><rect x="14.3" y="9" width="3.4" height="14" rx="1.3"/><rect x="10.6" y="14.3" width="10.8" height="2.7" rx="1.3"/></g></svg>';
